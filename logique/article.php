<?php
  ...
  {
    // Variables
    private var $int_id_article;
    private var $string_nom;
    private var $file_fichier;
    private var $int_id_sous_categorie_fk;
    private var $int_id_etat_fk;

    // Constructor
    public function __construct($new_id_article, $new_nom,
