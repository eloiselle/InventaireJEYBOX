...
<?php
  ...
  {
    // Variables
    var $int_id_contact_urgence;
    var $string_prenom;
    var $string_nom;
    var $string_relation;
    var $string_telephone;
    var $string_nom_utilisateur_fk;
    ...
    // Setters
    function set_id_contact_urgence($new_id_contact_urgence) {
    ...
    function set_relation($new_relation) {
    ...
    // Getters
    function get_id_contact_urgence() {
